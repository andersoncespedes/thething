...
INSERT INTO actividad VALUES("96","Regreso a clases presenciales","REALIZADA","regleso a clases despues del ciclo epidimiologico por causa del covid 19","2022-02-21","imagen/273973193_1345142395947290_282746393224633599_n.jpg","25342515","Kira  Villalba","10");
INSERT INTO actividad VALUES("97","sdijaisdaisdaidssa","DESCARTADA","sdasdkasjdoiajdioajdoiajsdojaisdjai j ijdai jdioajod idjasoidjaijs iajfjdgpkdf prkw","2022-03-18","imagen/","1372611123","Kira  Villalba","13");
...
INSERT INTO estadistica VALUES("93","REALIZADA","2022-02-21","1","Regreso a clases presenciales","25342515","Kira  Villalba","10");
INSERT INTO estadistica VALUES("94","DESCARTADA","2022-03-18","1","sdijaisdaisdaidssa","1372611123","Kira  Villalba","13");
...
INSERT INTO estudiante VALUES("16","Jhoan ","Riverol","256667835","1er Grado Seccion A","2017","1","Masculino");
...
INSERT INTO estudiante VALUES("23","Luciano","Alvarado","11822888","1er Grado Seccion A","2016","1","Masculino");
INSERT INTO estudiante VALUES("24","Alanis","Sandoval","11817839720","3er Grado Seccion A","2016","1","Femenino");
INSERT INTO estudiante VALUES("25","Kerly ","Medina","11819475369","3er Grado Seccion A","2014","1","Femenino");
...
INSERT INTO grado VALUES("14","2do Grado","Seccion A","Neyslen  Jimenez");
...
INSERT INTO maestro VALUES("19","Marlon ","Guevara","16225654","ejemplo@gmail.com","1993-02-18","urbanizaci?n San Jose De las Moreas calle principal","2006");
...
CREATE TABLE `nombre_vacuna` (
  `id_nomvacuna` int(11) NOT NULL AUTO_INCREMENT,
  `nombvacuna` varchar(40) NOT NULL,
  PRIMARY KEY (`id_nomvacuna`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

INSERT INTO nombre_vacuna VALUES("1","Sputnik V");
INSERT INTO nombre_vacuna VALUES("2","CoronaVac");
INSERT INTO nombre_vacuna VALUES("3","Vero Cell");
INSERT INTO nombre_vacuna VALUES("4","Abdala");
INSERT INTO nombre_vacuna VALUES("5","Sputnik Light");
INSERT INTO nombre_vacuna VALUES("6","Ninguna");
...
INSERT INTO participante VALUES("151","25","97","");
INSERT INTO participante VALUES("152","24","97","");
INSERT INTO participante VALUES("153","23","97","");
INSERT INTO participante VALUES("154","22","97","");
INSERT INTO participante VALUES("155","21","97","");
INSERT INTO participante VALUES("156","20","97","");
INSERT INTO participante VALUES("157","19","97","");
INSERT INTO participante VALUES("158","18","97","");
...
CREATE TABLE `representante` (
  ...
  UNIQUE KEY `cedula_rep` (`cedula_rep`,`correo_rep`),
  KEY `id_estudiante` (`id_estudiante`),
...
INSERT INTO usuario VALUES("26","anderson","cespedes","27010387","1999-11-15","aaaax","xxxx","andersontrabajos2@gmail.com","imagen/sombrero-de-graduacion.png","administrador","desactvado");
...
CREATE TABLE `vacunacion` (
  ...
  `nombre_vacuna2` varchar(50) NOT NULL,
  `fecha_segunda_d` varchar(40) NOT NULL,
  `nombre_vacuna3` varchar(50) NOT NULL,
  `fecha_tercera_d` varchar(40) NOT NULL,
  `id_estudiante` int(11) NOT NULL,
  `est_v` int(32) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_vacuna`),
  UNIQUE KEY `id_estudiante_2` (`id_estudiante`),
  KEY `id_estudiante` (`id_estudiante`),
...
INSERT INTO vacunacion VALUES("16","Ninguna","2022-03-25","Ninguna","2022-03-18","Ninguna","2022-03-23","16","1");
INSERT INTO vacunacion VALUES("18","Sputnik Light","2022-03-03","Sputnik Light","2022-03-12","Sputnik Light","2022-03-12","25","1");
